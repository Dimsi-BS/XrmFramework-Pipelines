...
function GetEnvironment {
    ...
    Write-Verbose "Get-AdminPowerAppEnvironment = $(Get-AdminPowerAppEnvironment | Select-Object {$_.Internal.properties.linkedEnvironmentMetadata.instanceUrl} | Format-Table | Out-String)"
